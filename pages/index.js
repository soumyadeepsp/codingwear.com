  ...
  return (
    <div>
      <Head>
        ...
        <meta name="codingwear.com" content="codingwear.com - Wear your code" />
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Wear the code with codingwear.com</h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Show the world your love for code with the coolest coding goodies!</p>
          </div>
